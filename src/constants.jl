...
const EVAP_THRESHOLD = 273.15           # Minimum temperature for evaporation (K)
...
const MOISTURE_DIFFUSION = 0.7e-4         # Base moisture diffusion coefficient (1/s)
